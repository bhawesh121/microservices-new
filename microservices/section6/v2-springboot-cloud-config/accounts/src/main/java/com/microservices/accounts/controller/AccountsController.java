...
@Validated
@Tag(
        name="CRUD REST APIs for Accounts in MoneyManager",
...
public class AccountsController {
    ...
    @Operation(
            summary = "Fetch Account details via Mobile Number",
    ...
    @ApiResponses({
            ...
            @ApiResponse(
                    responseCode = "500",
                    description = "HTTP Staus INTERNAL SERVER ERROR",
                    content = @Content(
                            schema = @Schema(implementation = ErrorResponseDto.class)
                    )
            )
    ...
    @Operation(
            summary = "Delete Account via Mobile number REST APIs",
    ...
    @Operation(
            ...
            description = "Get Build Information from Microservices"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "Get Java version Information from Microservices"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "Get Contact Information from Microservices"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
