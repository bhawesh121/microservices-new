...
public class CardsController {
    ...
    @Operation(
            ...
            description = "REST APIs to create new Cards inside MoneyManager"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            summary = "Fetch Card Contact Details REST API",
            description = "REST API to fetch card contact details based on a mobile number"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "Get Java version using Rest APIs"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "Get build version using Rest APIs"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
